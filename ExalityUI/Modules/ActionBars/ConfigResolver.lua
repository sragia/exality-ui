...
resolver.GetBarConfig = function(self, db, barId)
    ...
    local resolved = {
        ...
        showHotkey = useGlobalAppearance and global.showHotkey or bar.showHotkey,
        showMacro = useGlobalAppearance and global.showMacro or bar.showMacro,
        showStacks = useGlobalAppearance and global.showStacks or bar.showStacks,
