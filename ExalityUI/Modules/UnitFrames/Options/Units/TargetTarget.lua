    ...
    menu = {
        {
            ...
            options = {
                function()
                    return EXUI:GetModule('uf-options-general-frame'):GetOptions('targettarget')
                end
            }
        },
        {
        ...
        },
        {
            ...
            options = {
                function()
                    return EXUI:GetModule('uf-options-generic-auras'):GetOptions('targettarget', 'auras', false, true)
                end
            }
        },
        {
