        ...
        },
        {
            ...
            options = function()
                ...
                return {
                    ...
                    colorWhen('Aggro', 'threatHaveAggro', 33, 'colorThreat'),
                    colorWhen('Losing Aggro', 'threatAggroLow', 33, 'colorThreat'),
                    colorWhen('No Aggro', 'threatNoAggro', 33, 'colorThreat'),
                    ...
                    helpers.Toggle('Color Neutral', 'colorNeutral'),
                    colorWhen('Neutral Color', 'neutralColor', 50, 'colorNeutral'),
                    colorWhen('Unfriendly Color', 'unfriendlyColor', 50, 'colorNeutral'),
                    helpers.Toggle('Color Casters in Instances', 'colorCaster'),
                    colorWhen('Caster Color', 'casterColor', 50, 'colorCaster'),
                    { type = 'title', label = 'Rank',  width = 100 },
                    helpers.Toggle('Color Miniboss', 'colorMiniboss'),
                    colorWhen('Miniboss Color', 'minibossColor', 50, 'colorMiniboss'),
