...
---@class EXUIInputGroupOptions = {name: string, children: table}

---@class EXUIInputGroup
local inputGroup = EXUI:GetModule('input-group')
...
---Create Input Group
---@param self EXUIInputGroup
---@param options EXUIInputGroupOptions
---@param parent Frame
---@return Frame
