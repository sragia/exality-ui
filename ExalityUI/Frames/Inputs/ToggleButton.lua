...
---@class EXUIToggleButtonOptions : {text: string, onClick: function, size?: table<number>, color?: table<number>}

---@class EXUIToggleButton
local button = EXUI:GetModule('toggle-button')
...
---@param self EXUIToggleButton
---@param options EXUIToggleButtonOptions
---@param parent Frame
---@return Frame
