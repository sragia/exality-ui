...
---@class EXUIRangeInput
local range = EXUI:GetModule('range-input')
...
local function ConfigureFrame(f)
    ...
    leftButtonTexture:SetTexture(EXUI.const.textures.frame.range.leftArrow)
    leftButtonTexture:SetVertexColor(1, 1, 1, 1)
    leftButtonTexture:SetAllPoints()

    leftButton:SetScript('OnEnter', function(self)
        leftButtonTexture:SetTexture(EXUI.const.textures.frame.range.leftArrowActive)
    end)
    ...
    rightButtonTexture:SetTexture(EXUI.const.textures.frame.range.rightArrow)
    rightButtonTexture:SetVertexColor(1, 1, 1, 1)
    rightButtonTexture:SetAllPoints()

    rightButton:SetScript('OnEnter', function(self)
        rightButtonTexture:SetTexture(EXUI.const.textures.frame.range.rightArrowActive)
    end)
    ...
    track:SetTexture(EXUI.const.textures.frame.range.track)
    track:SetAllPoints()
    ...
    dot:SetScript('OnMouseDown', function(self)
        ...
        dotTexture:SetTexture(EXUI.const.textures.frame.range.dotActive)
    ...
    editBoxBg:SetTexture(EXUI.const.textures.frame.range.editbox)
    editBoxBg:SetVertexColor(1, 1, 1, 1)
    editBoxBg:SetAllPoints()
    local editBox = CreateFrame('EditBox', nil, editBoxContainer)
    editBox:SetFont(EXUI.const.fonts.DEFAULT, 10, 'OUTLINE')
