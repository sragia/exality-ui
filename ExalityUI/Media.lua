...
LSM:Register('statusbar', 'ExalityUI Noisy', [[Interface/Addons/ExalityUI/Assets/Images/StatusBar/noisy]])
LSM:Register('statusbar', 'ExalityUI Absorb Bar', [[Interface/Addons/ExalityUI/Assets/Images/UnitFrames/absorb.png]])
